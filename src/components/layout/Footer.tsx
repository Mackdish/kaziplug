      ...
      <div className="container py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          <div className="space-y-4">
            ...
            <p className="text-background/70 text-sm leading-relaxed">Connect with skilled freelancers or find your next project. Secure payments, trusted escrow system.</p>
          </div>

          <div className="space-y-4">
            <h4 className="font-semibold">For Clients</h4>
            <ul className="space-y-3 text-sm text-background/70">
              <li><Link to="/post-task" className="hover:text-background transition-colors">Post a Task</Link></li>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3 text-sm text-background/70">
              ...
              <li><Link to="/register?role=freelancer" className="hover:text-background transition-colors">Create Profile</Link></li>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3 text-sm text-background/70">
              <li className="flex items-center gap-2"><Mail className="h-4 w-4" /><a href="mailto:support@nextgig.co.ke" className="hover:text-background transition-colors">support@nextgig.co.ke</a></li>
              <li className="flex items-center gap-2"><MapPin className="h-4 w-4" /><Link to="/contact" className="hover:text-background transition-colors">Nairobi, Kenya</Link></li>
            </ul>
          </div>
        </div>

        <div className="border-t border-background/10 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-background/50">© {new Date().getFullYear()} NextGig. All rights reserved.</p>
